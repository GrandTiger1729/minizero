...
constexpr bool more_than_one(Bitboard b) { return static_cast<bool>(b & (b - 1)); }
...
inline bool aligned(Square s1, Square s2, Square s3) { return static_cast<bool>(line_bb(s1, s2) & s3); }
...
inline int popcount(Bitboard b)
{
    ...
    return static_cast<int>(_mm_popcnt_u64(b._Word[1])) + static_cast<int>(_mm_popcnt_u64(b._Word[0]));
